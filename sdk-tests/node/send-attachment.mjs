...
(async function main() {
  try {
    ...
    Sentry.setTag('faultkeep.sdk_test', 'node-attachment');

    const error = new Error('Faultkeep real Node SDK attachment compatibility event');
    error.name = 'FaultkeepSdkAttachmentCompatibilityError';
