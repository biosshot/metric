...
helm install metric oci://ghcr.io/biosshot/charts/metric \
  --version 0.1.5 --namespace metric --wait --timeout 10m
...
Unreleased source may differ from the already published image with the same Cargo
version; the first public chart ships with the next Metric release.
