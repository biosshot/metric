...
| | **Metric 0.1.1** | **Self-hosted Sentry 26.7.2** |
| --- | --- | --- |
...
Metric 0.1.1 is tested with real processes of:
...
`ghcr.io/biosshot/metric:0.1.1` and starts the recommended Medium profile.
