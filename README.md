...
> Metric 0.1.5 is an early release. Read the
...
| | **Metric 0.1.5** | **Self-hosted Sentry 26.7.2** |
| --- | --- | --- |
...
Metric 0.1.5 is tested with real processes of:
...
`ghcr.io/biosshot/metric:0.1.5` and starts the recommended Medium profile.
