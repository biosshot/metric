...
> Metric 0.1.4 is an early release. Read the
...
| | **Metric 0.1.4** | **Self-hosted Sentry 26.7.2** |
| --- | --- | --- |
...
Metric 0.1.4 is tested with real processes of:
...
`ghcr.io/biosshot/metric:0.1.4` and starts the recommended Medium profile.
