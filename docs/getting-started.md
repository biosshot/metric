...
```bash
curl -fsSL https://raw.githubusercontent.com/biosshot/metric/v0.1.4/deploy/install.sh | sh
```

Another profile:

```bash
curl -fsSL https://raw.githubusercontent.com/biosshot/metric/v0.1.4/deploy/install.sh \
...
```powershell
irm https://raw.githubusercontent.com/biosshot/metric/v0.1.4/deploy/install.ps1 | iex
```
...
You can review the
[Linux installer](https://github.com/biosshot/metric/blob/v0.1.4/deploy/install.sh)
or [Windows installer](https://github.com/biosshot/metric/blob/v0.1.4/deploy/install.ps1)
before running it.
...
- [`compose.yml`](https://github.com/biosshot/metric/blob/v0.1.4/deploy/compose.yml)
  describes all available containers;
- `metric.toml` is the selected Min, Low, Medium or High configuration;
- [`symbolicator.yml`](https://github.com/biosshot/metric/blob/v0.1.4/deploy/symbolicator.yml)
...
- [compose.yml](https://raw.githubusercontent.com/biosshot/metric/v0.1.4/deploy/compose.yml)
- [symbolicator.yml](https://raw.githubusercontent.com/biosshot/metric/v0.1.4/deploy/symbolicator.yml)

Then choose one pair and save it under the name shown:

| Profile | Save as `metric.toml` | Save as `.env` |
| --- | --- | --- |
| Min | [min.toml](https://raw.githubusercontent.com/biosshot/metric/v0.1.4/deploy/profiles/min.toml) | [min.env.example](https://raw.githubusercontent.com/biosshot/metric/v0.1.4/deploy/profiles/min.env.example) |
| Low | [low.toml](https://raw.githubusercontent.com/biosshot/metric/v0.1.4/deploy/profiles/low.toml) | [low.env.example](https://raw.githubusercontent.com/biosshot/metric/v0.1.4/deploy/profiles/low.env.example) |
| Medium | [medium.toml](https://raw.githubusercontent.com/biosshot/metric/v0.1.4/deploy/profiles/medium.toml) | [medium.env.example](https://raw.githubusercontent.com/biosshot/metric/v0.1.4/deploy/profiles/medium.env.example) |
| High | [high.toml](https://raw.githubusercontent.com/biosshot/metric/v0.1.4/deploy/profiles/high.toml) | [high.env.example](https://raw.githubusercontent.com/biosshot/metric/v0.1.4/deploy/profiles/high.env.example) |
