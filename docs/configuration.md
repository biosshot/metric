...
| --- | --- |
| [`min.toml`](https://github.com/biosshot/metric/blob/v0.1.2/deploy/profiles/min.toml) | Minimum memory and disk use; no Symbolicator or attachments. |
| [`low.toml`](https://github.com/biosshot/metric/blob/v0.1.2/deploy/profiles/low.toml) | Small installation with attachments but no Symbolicator. |
| [`medium.toml`](https://github.com/biosshot/metric/blob/v0.1.2/deploy/profiles/medium.toml) | Recommended default with Symbolicator. |
| [`high.toml`](https://github.com/biosshot/metric/blob/v0.1.2/deploy/profiles/high.toml) | Larger queues, files, storage and retention. |
