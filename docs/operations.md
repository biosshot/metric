...
application workers. Metric automatically migrates complete generation-19 and generation-20 databases
to generation 21. Earlier generations have no supported transition chain.
